...
const authMiddleware = require('../middleware/auth');  // Assuming this is a middleware that checks if a user is authenticated
...
router.post('/dishes', authMiddleware, async (req, res) => {
    try {
        ...
        if (Array.isArray(dishes)) {
            ...
            const newDish = new Dish({ name, category, description, price, imageUrl });
            await newDish.save();
